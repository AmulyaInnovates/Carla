...
def semantic_lidar_data(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        # Task 02: Reading Data and Applying a Model
        ...
        if distance_name_data["name"] == "Vehicles":
            # Task 03: Getting Prediction by applying condition
            if prediction == 1:
                # Car should take reverse with throttle as 1 and reverse light ON
                ...
                # Car should move forward with throttle as 0.5 and low beam light ON
