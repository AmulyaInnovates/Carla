...
def generate_radar_blueprint(blueprint_library):
    radar_sensor= blueprint_library.filter('sensor.other.radar')[0]
    radar_sensor.set_attribute('horizontal_fov' , str(10))
    radar_sensor.set_attribute('vertical_fov' , str(10))
    radar_sensor.set_attribute('points_per_second' , str(15000))
    radar_sensor.set_attribute('range' , str(10))
    return radar_sensor
...
try:
    ...
    mustang_car = world.spawn_actor(car_model, mustang_car_spawn_point)
