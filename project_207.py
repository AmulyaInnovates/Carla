...
def car_control():
    dropped_vehicle.apply_control(carla.VehicleControl(speed=0.5))
    time.sleep(6)
    dropped_vehicle.apply_control(carla.VehicleControl(steer=-0.6))
    time.sleep(4)
    dropped_vehicle.apply_control(carla.VehicleControl(throtttle=0.7,speed=0.4))
    time.sleep(6)
...
try:
    ...
    if location != Location(x=66.648193, y=0.766224, z=0.162060):
        dropped_vehicle.apply_control(carla.VehicleControl(throtttle=0.7,reverse=0.4))
        time.sleep(6)
