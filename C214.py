...
def generate_lidar_library(blueprint_library):
...
def lidar_data(point_cloud , lidar_point_cloud_buffer):
	...
	reshape_of_image=np.reshape(matrix_representational_data,(int(matrix_representational_data[0] / 4), 4))
...
try:
    ...
    sensor.listen(lambda data:lidar_data,lidar_point_cloud_buffer)
